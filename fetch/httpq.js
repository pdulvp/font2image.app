...
var httpq = {
	...
	get: function(host, path) {
		return httpq.request(host, path, undefined, "GET", httpq.user, httpq.password);
	},
	
	post: function(host, path, object) {
		return httpq.request(host, path, object, 'POST', httpq.user, httpq.password);
	},
	
	put: function(host, path, object) {
		return httpq.request(host, path, object, "PUT", httpq.user, httpq.password);
	},
	
	patch: function(host, path, object) {
		return httpq.request(host, path,  object, "PATCH", httpq.user, httpq.password);
	}
};

  module.exports = httpq;
